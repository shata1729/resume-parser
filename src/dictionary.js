...
module.exports = {
  titles: {
    ...
    experience: ['experience','EXPERIENCE','Work History','experiences','professional experience','PROFESSIONAL EXPERIENCE','previous employment','earlier positions'],
    education: ['education','EDUCATION'],
    skills: ['skills', 'Skills & Expertise', 'technology', 'technologies','Core Skills','software proficiency','SKILLS'],
    languages: ['languages'],
    courses: ['courses'],
    projects: ['projects'],
    links: ['links'],
    ...
    awards: ['awards','accomplishments','PROFESSIONAL ACHIEVEMENTS'],
    honors: ['honors'],
